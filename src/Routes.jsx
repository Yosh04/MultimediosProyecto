...
class Home extends React.Component {
    ...
    render() {
        const images = [
            { src: 'https://lumiere-a.akamaihd.net/v1/images/disney-gallery-the-mandalorian-s3-module-hero-desktop_d6f7c4e1.jpeg?region=0,0,2048,878', alt: 'Image 1', side:"BoxPlaceLeft"},
            { src: 'https://lumiere-a.akamaihd.net/v1/images/sw-outlaws-sashsingle-hero-desktop_08d0cff1.jpeg?region=0,0,2048,878', alt: 'Image 2', side:"BoxPlaceRigth" },
            { src: 'https://lumiere-a.akamaihd.net/v1/images/obi-wan-marvel-sashsingle-hero-desktop_6cd9c70f.jpeg?region=0,0,2048,878', alt: 'Image 3',side:"BoxPlaceLeft" },
          ];
